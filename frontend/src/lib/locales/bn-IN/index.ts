export const bnIN = {
  ...
  studio: {
    ...
    generateFirstFlashcards: "ফ্ল্যাশকার্ড তৈরি করতে আপনার উৎস থেকে শেখা শুরু করুন।",
    noMindMapYet: "এখনও কোনো মাইন্ড ম্যাপ নেই",
    generateFirstMindMap: "ধারণাগুলি ভিজ্যুয়ালাইজ করতে আপনার উৎস থেকে একটি মাইন্ড ম্যাপ তৈরি করুন।",
    question: "প্রশ্ন",
    answer: "উত্তর",
    flipToAnswer: "ফ্লিপ করতে ক্লিক করুন",
    flipToQuestion: "ফিরে যেতে ক্লিক করুন",
    cardOf: "কার্ড {current} / {total}",
    previousCard: "পূর্ববর্তী",
    nextCard: "পরবর্তী",
    deleteFlashcards: "ফ্ল্যাশকার্ড মুছুন",
    deleteFlashcardsConfirm: "সব ফ্ল্যাশকার্ড মুছে ফেলতে চান?",
    flashcardDeletedSuccess: "ফ্ল্যাশকার্ড মুছে ফেলা হয়েছে",
    flashcardGeneratedSuccess: "ফ্ল্যাশকার্ড তৈরি হয়েছে",
    mindMapGeneratedSuccess: "মাইন্ড ম্যাপ তৈরি হয়েছে",
    mindMapDeletedSuccess: "মাইন্ড ম্যাপ মুছে ফেলা হয়েছে",
    mindmapRenderError: "মাইন্ড ম্যাপ রেন্ডার করতে ব্যর্থ",
    failedToGenerate: "কন্টেন্ট তৈরি ব্যর্থ",
    failedToDelete: "কন্টেন্ট মুছে ফেলতে ব্যর্থ",
  },
}
