export const esES = {
  ...
  studio: {
    ...
    generateFirstFlashcards: "Genera tarjetas de tus fuentes para empezar a estudiar.",
    noMindMapYet: "Aún no hay mapa mental",
    generateFirstMindMap: "Genera un mapa mental de tus fuentes para visualizar conceptos.",
    question: "Pregunta",
    answer: "Respuesta",
    flipToAnswer: "Haz clic para voltear",
    flipToQuestion: "Haz clic para volver",
    cardOf: "Tarjeta {current} de {total}",
    previousCard: "Anterior",
    nextCard: "Siguiente",
    deleteFlashcards: "Eliminar Tarjetas",
    deleteFlashcardsConfirm: "¿Estás seguro de que quieres eliminar todas las tarjetas?",
    flashcardDeletedSuccess: "Tarjetas eliminadas",
    flashcardGeneratedSuccess: "Tarjetas generadas",
    mindMapGeneratedSuccess: "Mapa mental generado",
    mindMapDeletedSuccess: "Mapa mental eliminado",
    mindmapRenderError: "Error al renderizar el mapa mental",
    failedToGenerate: "Error al generar contenido",
    failedToDelete: "Error al eliminar contenido",
  },
}
