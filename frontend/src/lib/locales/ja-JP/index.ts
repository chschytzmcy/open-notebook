export const jaJP = {
  ...
  studio: {
    ...
    generating: "生成中...",
    regenerate: "再生成",
    noFlashcardsYet: "フラッシュカードがありません",
    generateFirstFlashcards: "ソースからフラッシュカードを生成して学習を始めましょう",
    noMindMapYet: "マインドマップがありません",
    generateFirstMindMap: "ソースからマインドマップを生成して概念を可視化しましょう",
    question: "質問",
    answer: "回答",
    flipToAnswer: "クリックで反転",
    flipToQuestion: "クリックで戻る",
    cardOf: "{total}枚中 {current}枚目",
    previousCard: "前へ",
    nextCard: "次へ",
    deleteFlashcards: "フラッシュカードを削除",
    deleteFlashcardsConfirm: "すべてのフラッシュカードを削除しますか？",
    flashcardDeletedSuccess: "フラッシュカードを削除しました",
    flashcardGeneratedSuccess: "フラッシュカードを生成しました",
    mindMapGeneratedSuccess: "マインドマップを生成しました",
    mindMapDeletedSuccess: "マインドマップを削除しました",
    mindmapRenderError: "マインドマップのレンダリングに失敗しました",
    failedToGenerate: "コンテンツの生成に失敗しました",
    failedToDelete: "コンテンツの削除に失敗しました",
  },
}
