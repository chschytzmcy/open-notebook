export const ptBR = {
  ...
  studio: {
    ...
    noFlashcardsYet: "Nenhum flashcard ainda",
    generateFirstFlashcards: "Gere flashcards das suas fontes para começar a estudar.",
    noMindMapYet: "Nenhum mapa mental ainda",
    generateFirstMindMap: "Gere um mapa mental das suas fontes para visualizar conceitos.",
    question: "Pergunta",
    answer: "Resposta",
    flipToAnswer: "Clique para virar",
    flipToQuestion: "Clique para voltar",
    cardOf: "Cartão {current} de {total}",
    previousCard: "Anterior",
    nextCard: "Próximo",
    deleteFlashcards: "Excluir Flashcards",
    deleteFlashcardsConfirm: "Tem certeza que deseja excluir todos os flashcards?",
    flashcardDeletedSuccess: "Flashcards excluídos",
    flashcardGeneratedSuccess: "Flashcards gerados",
    mindMapGeneratedSuccess: "Mapa mental gerado",
    mindMapDeletedSuccess: "Mapa mental excluído",
    mindmapRenderError: "Falha ao renderizar mapa mental",
    failedToGenerate: "Falha ao gerar conteúdo",
    failedToDelete: "Falha ao excluir conteúdo",
  },
}
