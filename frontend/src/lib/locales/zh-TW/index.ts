export const zhTW = {
  ...
  studio: {
    ...
    generating: "生成中...",
    regenerate: "重新生成",
    noFlashcardsYet: "暫無閃卡",
    generateFirstFlashcards: "從來源生成閃卡開始學習",
    noMindMapYet: "暫無思維導圖",
    generateFirstMindMap: "從來源生成思維導圖以視覺化概念",
    question: "問題",
    answer: "答案",
    flipToAnswer: "點擊翻轉",
    flipToQuestion: "點擊翻回",
    cardOf: "第 {current} / {total} 張",
    previousCard: "上一張",
    nextCard: "下一張",
    deleteFlashcards: "刪除閃卡",
    deleteFlashcardsConfirm: "確定要刪除所有閃卡嗎？",
    flashcardDeletedSuccess: "閃卡已刪除",
    flashcardGeneratedSuccess: "閃卡已生成",
    mindMapGeneratedSuccess: "思維導圖已生成",
    mindMapDeletedSuccess: "思維導圖已刪除",
    mindmapRenderError: "思維導圖渲染失敗",
    failedToGenerate: "生成內容失敗",
    failedToDelete: "刪除內容失敗",
  },
}
