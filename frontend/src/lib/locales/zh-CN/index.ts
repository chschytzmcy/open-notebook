export const zhCN = {
  ...
  studio: {
    ...
    generateFirstFlashcards: "从资料来源生成闪卡开始学习",
    noMindMapYet: "暂无思维导图",
    generateFirstMindMap: "从资料来源生成思维导图以可视化概念",
    question: "问题",
    answer: "答案",
    flipToAnswer: "点击翻转",
    flipToQuestion: "点击翻转回来",
    cardOf: "第 {current} / {total} 张",
    previousCard: "上一张",
    nextCard: "下一张",
    deleteFlashcards: "删除闪卡",
    deleteFlashcardsConfirm: "确定要删除所有闪卡吗？",
    flashcardDeletedSuccess: "闪卡已删除",
    flashcardGeneratedSuccess: "闪卡已生成",
    mindMapGeneratedSuccess: "思维导图已生成",
    mindMapDeletedSuccess: "思维导图已删除",
    mindmapRenderError: "思维导图渲染失败",
    failedToGenerate: "生成内容失败",
    failedToDelete: "删除内容失败",
  },
}
