export const ruRU = {
  ...
  studio: {
    ...
    noFlashcardsYet: "Пока нет карточек",
    generateFirstFlashcards: "Создайте карточки из источников, чтобы начать обучение.",
    noMindMapYet: "Пока нет интеллект-карты",
    generateFirstMindMap: "Создайте интеллект-карту из источников для визуализации концепций.",
    question: "Вопрос",
    answer: "Ответ",
    flipToAnswer: "Нажмите, чтобы перевернуть",
    flipToQuestion: "Нажмите, чтобы вернуть",
    cardOf: "Карточка {current} из {total}",
    previousCard: "Предыдущая",
    nextCard: "Следующая",
    deleteFlashcards: "Удалить карточки",
    deleteFlashcardsConfirm: "Вы уверены, что хотите удалить все карточки?",
    flashcardDeletedSuccess: "Карточки удалены",
    flashcardGeneratedSuccess: "Карточки созданы",
    mindMapGeneratedSuccess: "Интеллект-карта создана",
    mindMapDeletedSuccess: "Интеллект-карта удалена",
    mindmapRenderError: "Ошибка отображения интеллект-карты",
    failedToGenerate: "Ошибка создания контента",
    failedToDelete: "Ошибка удаления контента",
  },
}
