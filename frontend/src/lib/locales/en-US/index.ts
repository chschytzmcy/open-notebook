export const enUS = {
  ...
  studio: {
    ...
    generateFirstFlashcards: "Generate flashcards from your sources to start studying.",
    noMindMapYet: "No mind map yet",
    generateFirstMindMap: "Generate a mind map from your sources to visualize concepts.",
    question: "Question",
    answer: "Answer",
    ...
    deleteFlashcardsConfirm: "Are you sure you want to delete all flashcards?",
    flashcardDeletedSuccess: "Flashcards deleted",
    flashcardGeneratedSuccess: "Flashcards generated",
    mindMapGeneratedSuccess: "Mind map generated",
    mindMapDeletedSuccess: "Mind map deleted",
    mindmapRenderError: "Failed to render mind map",
