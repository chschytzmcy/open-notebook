export const frFR = {
  ...
  studio: {
    ...
    generateFirstFlashcards: "Générez des flashcards à partir de vos sources pour commencer à étudier.",
    noMindMapYet: "Pas encore de carte mentale",
    generateFirstMindMap: "Générez une carte mentale à partir de vos sources pour visualiser les concepts.",
    question: "Question",
    answer: "Réponse",
    flipToAnswer: "Cliquez pour retourner",
    flipToQuestion: "Cliquez pour revenir",
    cardOf: "Carte {current} sur {total}",
    previousCard: "Précédent",
    nextCard: "Suivant",
    deleteFlashcards: "Supprimer les Flashcards",
    deleteFlashcardsConfirm: "Êtes-vous sûr de vouloir supprimer tous les flashcards ?",
    flashcardDeletedSuccess: "Flashcards supprimés",
    flashcardGeneratedSuccess: "Flashcards générés",
    mindMapGeneratedSuccess: "Carte mentale générée",
    mindMapDeletedSuccess: "Carte mentale supprimée",
    mindmapRenderError: "Échec du rendu de la carte mentale",
    failedToGenerate: "Échec de la génération du contenu",
    failedToDelete: "Échec de la suppression du contenu",
  },
}
