export const itIT = {
  ...
  studio: {
    ...
    generating: "Generazione...",
    regenerate: "Rigenera",
    noFlashcardsYet: "Nessuna flashcard ancora",
    generateFirstFlashcards: "Genera flashcard dalle tue fonti per iniziare a studiare.",
    noMindMapYet: "Nessuna mappa mentale ancora",
    generateFirstMindMap: "Genera una mappa mentale dalle tue fonti per visualizzare i concetti.",
    question: "Domanda",
    answer: "Risposta",
    flipToAnswer: "Clicca per girare",
    flipToQuestion: "Clicca per tornare",
    cardOf: "Scheda {current} di {total}",
    previousCard: "Precedente",
    nextCard: "Successivo",
    deleteFlashcards: "Elimina Flashcard",
    deleteFlashcardsConfirm: "Sei sicuro di voler eliminare tutte le flashcard?",
    flashcardDeletedSuccess: "Flashcard eliminate",
    flashcardGeneratedSuccess: "Flashcard generate",
    mindMapGeneratedSuccess: "Mappa mentale generata",
    mindMapDeletedSuccess: "Mappa mentale eliminata",
    mindmapRenderError: "Errore nel rendering della mappa mentale",
    failedToGenerate: "Errore nella generazione del contenuto",
    failedToDelete: "Errore nell'eliminazione del contenuto",
  },
}
